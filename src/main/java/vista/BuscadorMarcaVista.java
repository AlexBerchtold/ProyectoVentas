...
import controlador.BuscadorMarcaController;

public class BuscadorMarcaVista extends JDialog {
	...
	private BuscadorMarcaController controller;
	

	public void setUpController() {
		controller = new BuscadorMarcaController(this);
	}

	/**
	 * Create the dialog.
	 */
	public BuscadorMarcaVista() {
		getContentPane().setBackground(new Color(230, 230, 250));
		setTitle("Buscador de Marcas");
	...
	public BuscadorMarcaController getController() {
		return controller;
	}
